module.exports = {
  ...
  communitySQ: 'sq.m',
  communityGW: 'desks',
  communityDefault: 'Sorry, no matching community has been found, please re-filter the condition',
  communityMeta: {
    tit: 'Kr Space-Office community',
    key: 'Office community,Kr Space',
    des: 'Kr Space runs co-working community in 11 cities, including Beijing, Shanghai and Guangzhou. By the end of June 2018, we already run more than 40 communities providing 35,000 workstations, direct managing over 200,000 sqm. in size.'
  },
  ...
  CMNT_DTL_Ask: 'The price includes: work station fee, property fee, cleaning fee, water and electricity fee, internet broadband fee, free conference room, free printing, free coffee and tea.',
  CMNT_DTL_Dw: 'desks',
  CMNT_DTL_Location: {
    subway: 'Subway',
    bank: 'Bank',
  ...
  newsMeta: {
    tit: 'Joint office news, Kr Space community report, community member report - Kr Space',
    key: 'Joint office news, Kr Space community report, community member report',
    des: 'Kr Space News and Information Channel reports the latest news of krypton space, financing news, opening news, development trends and the latest information of the whole joint office industry in real time.'
  },
  aboutMeta: {
  ...
  aboutSizeBream: [{name: 'Kr Space', url: '/'}, {name: 'Company profile', url: ''}],
  aboutNewsBream: [{name: 'Kr Space', url: '/'}, {name: 'News', url: ''}],
  aboutThingsBream: [{name: 'Kr Space', url: '/'}, {name: 'Milestones', url: ''}],
  aboutFeelBream: [{name: 'Kr Space', url: '/'}, {name: 'Office environment', url: ''}],
  aboutContactBream: [{name: 'Kr Space', url: '/'}, {name: 'Contact us', url: ''}],
  aboutJoinBream: [{name: 'Kr Space', url: '/'}, {name: 'Join us', url: ''}],
  aboutTab: [{
  ...
  aboutJoinTitle: 'Join us Resume delivery mailbox : hr@krspace.cn,Email subject marking job application + working life + name.',
  aboutJoinInfo: [
    {
      title: '社区经理',
      claims: [{
  ...
  aboutMilestone: [
    {
      ...
      year: '2018',
      month: 'June',
      content: 'Kr Space starts overseas expansion, signing Hongkong One Hennessy building'
    }, {
      year: '2018',
      month: 'May',
      content: 'Kr Space brand upgrade, launched the "joint office krypton space, the whole city business district you choose" new brand slogan.'
    }, {
      year: '2018',
      month: 'January',
      content: 'Kr Space announced the completion of 600 million yuan Pre-B round of financing.'
    }, {
      year: '2017',
      month: 'September',
      content: 'Kr Space announced that it has obtained a strategic investment over 100 million yuan from IDG Capital.'
    }, {
      year: '2017',
      month: 'July',
      content: 'Kr Space announced that it has obtained a strategic investment from China Minsheng Investment Group.'
    }, {
      year: '2016',
      month: 'November',
      content: 'Kr Space obtained A+ round of financing with over 200 million yuan from Prometheus Capital and IDG Capital.'
    }, {
      year: '2016',
      month: 'March',
      ...
      year: '2016',
      month: 'January',
      content: 'Kr Space split from 36 Kr and completed A-round financing independently.'
    }, {
      year: '2014',
      month: 'April',
